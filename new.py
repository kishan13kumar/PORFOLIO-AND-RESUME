...
def sidebar():
    ...
    st.sidebar.markdown("""
        ...
        """, unsafe_allow_html=True)    # Download Resume Button
...
def Projects():
    ...
    with st.expander("Medicine Recommendation System (2024)"):
        st.markdown("""
        The Allopathy Medicine Recommendation System is a sophisticated tool designed to assist healthcare professionals 
        ...
        care outcomes, and increase healthcare efficiency.
        """)
...
def Certifications():
    ...
    certifications = [
        ...
        {"title": "Python For Data Science", "provider": "IBM", "link": "https://www.credly.com/badges/f7efca15-02ec-46be-a0ac-84c62fea02b3/linked_in_profile"},
        {"title": "Data Analysis Using Python", "provider": "IBM", "link": "https://www.credly.com/badges/ef16ffb5-db3c-4ded-b41b-fcaa35b2d2da/linked_in_profile"},
...
def Contact():
    ...
    # Call the functions to build the app
