...
def sidebar():
    st.sidebar.markdown('''<img src='data:image/png;base64,{}' class='img-fluid' width=225 height=280>'''.format(img_to_bytes("kish.jpg")), unsafe_allow_html=True)
    ...
    data="profile.jpg"
    #st.sidebar.download_button("My Resume")
